...
public class MurderDetectionHandler {
    ...
    private void scanForMurderers() {
        ...
        for (EntityPlayer player : worldPlayers) {
            ...
            // Check if player has detective weapons (only if not already a murderer)
                ...
                // Track first bow holder (repeatable bow) - only if current player is NOT the starting detective
                if (firstBowHolder == null && !playerIsStartingDetective) {
                    firstBowHolder = playerName;
                    System.out.println("Murder Mystery Helper: " + playerName + " is the first bow holder (repeatable bow)!");
                }
    ...
    public static void updateGoldenDetectiveFromBowPickup() {
        ...
        if (closestPlayer != null) {
            ...
            System.out.println("Murder Mystery Helper: " + closestPlayer + " is now the golden detective (picked up bow)!");
